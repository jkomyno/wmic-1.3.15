...
static NTSTATUS browser__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 0: {
		...
		r2->out.result = BrowserrServerEnum(dce_call, mem_ctx, r2);
	...
	case 1: {
		...
		r2->out.result = BrowserrDebugCall(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 2: {
		...
		r2->out.result = BrowserrQueryOtherDomains(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 3: {
		...
		r2->out.result = BrowserrResetNetlogonState(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 4: {
		...
		r2->out.result = BrowserrDebugTrace(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 5: {
		...
		r2->out.result = BrowserrQueryStatistics(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 6: {
		...
		r2->out.result = BrowserResetStatistics(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 7: {
		...
		r2->out.result = NetrBrowserStatisticsClear(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 8: {
		...
		r2->out.result = NetrBrowserStatisticsGet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 9: {
		...
		r2->out.result = BrowserrSetNetlogonState(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 10: {
		...
		r2->out.result = BrowserrQueryEmulatedDomains(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 11: {
		...
		r2->out.result = BrowserrServerEnumEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
...
static const struct dcesrv_interface browser_interface = {
	.name		= "browser",
...
static NTSTATUS browser__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	for (i=0;i<dcerpc_table_browser.endpoints->count;i++) {
		...
		ret = dcesrv_interface_register(dce_ctx, name, &browser_interface, NULL);
...
{
	if (browser_interface.syntax_id.if_version == if_version &&
		GUID_equal(&browser_interface.syntax_id.uuid, uuid)) {
		memcpy(iface,&browser_interface, sizeof(*iface));
		return True;
	}
...
{
	if (strcmp(browser_interface.name, name)==0) {
		memcpy(iface,&browser_interface, sizeof(*iface));
		return True;
	}
