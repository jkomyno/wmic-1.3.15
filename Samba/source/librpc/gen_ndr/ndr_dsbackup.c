...
static NTSTATUS ndr_push_HrRBackupPrepare(struct ndr_push *ndr, int flags, const struct HrRBackupPrepare *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupPrepare(struct ndr_pull *ndr, int flags, struct HrRBackupPrepare *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupEnd(struct ndr_push *ndr, int flags, const struct HrRBackupEnd *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupEnd(struct ndr_pull *ndr, int flags, struct HrRBackupEnd *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupGetAttachmentInformation(struct ndr_push *ndr, int flags, const struct HrRBackupGetAttachmentInformation *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupGetAttachmentInformation(struct ndr_pull *ndr, int flags, struct HrRBackupGetAttachmentInformation *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupOpenFile(struct ndr_push *ndr, int flags, const struct HrRBackupOpenFile *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupOpenFile(struct ndr_pull *ndr, int flags, struct HrRBackupOpenFile *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupRead(struct ndr_push *ndr, int flags, const struct HrRBackupRead *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupRead(struct ndr_pull *ndr, int flags, struct HrRBackupRead *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupClose(struct ndr_push *ndr, int flags, const struct HrRBackupClose *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupClose(struct ndr_pull *ndr, int flags, struct HrRBackupClose *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupGetBackupLogs(struct ndr_push *ndr, int flags, const struct HrRBackupGetBackupLogs *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupGetBackupLogs(struct ndr_pull *ndr, int flags, struct HrRBackupGetBackupLogs *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupTruncateLogs(struct ndr_push *ndr, int flags, const struct HrRBackupTruncateLogs *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupTruncateLogs(struct ndr_pull *ndr, int flags, struct HrRBackupTruncateLogs *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRBackupPing(struct ndr_push *ndr, int flags, const struct HrRBackupPing *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRBackupPing(struct ndr_pull *ndr, int flags, struct HrRBackupPing *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call ad_backup_calls[] = {
	{
		"HrRBackupPrepare",
...
static const struct dcerpc_endpoint_list ad_backup_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list ad_backup_authservices = {
	.count	= 1,
	.names	= ad_backup_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_ad_backup = {
	.name		= "ad_backup",
	.syntax_id	= {
		{0xecec0d70,0xa603,0x11d0,{0x96,0xb1},{0x00,0xa0,0xc9,0x1e,0xce,0x30}},
		DCERPC_AD_BACKUP_VERSION
	},
	.helpstring	= DCERPC_AD_BACKUP_HELPSTRING,
	.num_calls	= 9,
...
static NTSTATUS ndr_push_HrRIsNTDSOnline(struct ndr_push *ndr, int flags, const struct HrRIsNTDSOnline *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRIsNTDSOnline(struct ndr_pull *ndr, int flags, struct HrRIsNTDSOnline *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestorePrepare(struct ndr_push *ndr, int flags, const struct HrRRestorePrepare *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestorePrepare(struct ndr_pull *ndr, int flags, struct HrRRestorePrepare *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreRegister(struct ndr_push *ndr, int flags, const struct HrRRestoreRegister *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreRegister(struct ndr_pull *ndr, int flags, struct HrRRestoreRegister *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreRegisterComplete(struct ndr_push *ndr, int flags, const struct HrRRestoreRegisterComplete *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreRegisterComplete(struct ndr_pull *ndr, int flags, struct HrRRestoreRegisterComplete *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreGetDatabaseLocations(struct ndr_push *ndr, int flags, const struct HrRRestoreGetDatabaseLocations *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreGetDatabaseLocations(struct ndr_pull *ndr, int flags, struct HrRRestoreGetDatabaseLocations *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreEnd(struct ndr_push *ndr, int flags, const struct HrRRestoreEnd *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreEnd(struct ndr_pull *ndr, int flags, struct HrRRestoreEnd *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreSetCurrentLogNumber(struct ndr_push *ndr, int flags, const struct HrRRestoreSetCurrentLogNumber *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreSetCurrentLogNumber(struct ndr_pull *ndr, int flags, struct HrRRestoreSetCurrentLogNumber *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_push_HrRRestoreCheckLogsForBackup(struct ndr_push *ndr, int flags, const struct HrRRestoreCheckLogsForBackup *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_HrRRestoreCheckLogsForBackup(struct ndr_pull *ndr, int flags, struct HrRRestoreCheckLogsForBackup *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call ad_restore_calls[] = {
	{
		"HrRIsNTDSOnline",
...
static const struct dcerpc_endpoint_list ad_restore_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list ad_restore_authservices = {
	.count	= 1,
	.names	= ad_restore_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_ad_restore = {
	.name		= "ad_restore",
	.syntax_id	= {
		{0x16e0cf3a,0xa604,0x11d0,{0x96,0xb1},{0x00,0xa0,0xc9,0x1e,0xce,0x30}},
		DCERPC_AD_RESTORE_VERSION
	},
	.helpstring	= DCERPC_AD_RESTORE_HELPSTRING,
	.num_calls	= 8,
