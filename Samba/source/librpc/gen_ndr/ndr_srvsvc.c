...
static const struct dcerpc_interface_call srvsvc_calls[] = {
	{
...
static const struct dcerpc_endpoint_list srvsvc_endpoints = {
	.count	= 3,
...
static const struct dcerpc_authservice_list srvsvc_authservices = {
	.count	= 3,
