...
static const struct dcerpc_interface_call eventlog_calls[] = {
	{
...
static const struct dcerpc_endpoint_list eventlog_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list eventlog_authservices = {
	.count	= 1,
