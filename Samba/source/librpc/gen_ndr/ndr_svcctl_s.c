...
static NTSTATUS svcctl__op_bind(struct dcesrv_call_state *dce_call, const struct dcesrv_interface *iface)
{
...
static NTSTATUS svcctl__op_ndr_pull(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_pull *pull, void **r)
{
	...
	if (opnum >= dcerpc_table_svcctl.num_calls) {
		dce_call->fault_code = DCERPC_FAULT_OP_RNG_ERROR;
		return NT_STATUS_NET_WRITE_FAULT;
	}

	*r = talloc_size(mem_ctx, dcerpc_table_svcctl.calls[opnum].struct_size);
	NT_STATUS_HAVE_NO_MEMORY(*r);

        /* unravel the NDR for the packet */
	status = dcerpc_table_svcctl.calls[opnum].ndr_pull(pull, NDR_IN, *r);
	if (!NT_STATUS_IS_OK(status)) {
		dcerpc_log_packet(&dcerpc_table_svcctl, opnum, NDR_IN,
...
static NTSTATUS svcctl__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 0: {
		...
		r2->out.result = svcctl_CloseServiceHandle(dce_call, mem_ctx, r2);
	...
	case 1: {
		...
		r2->out.result = svcctl_ControlService(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 2: {
		...
		r2->out.result = svcctl_DeleteService(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 3: {
		...
		r2->out.result = svcctl_LockServiceDatabase(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 4: {
		...
		r2->out.result = svcctl_QueryServiceObjectSecurity(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 5: {
		...
		r2->out.result = svcctl_SetServiceObjectSecurity(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 6: {
		...
		r2->out.result = svcctl_QueryServiceStatus(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 7: {
		...
		r2->out.result = svcctl_SetServiceStatus(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 8: {
		...
		r2->out.result = svcctl_UnlockServiceDatabase(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 9: {
		...
		r2->out.result = svcctl_NotifyBootConfigStatus(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 10: {
		...
		r2->out.result = svcctl_SCSetServiceBitsW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 11: {
		...
		r2->out.result = svcctl_ChangeServiceConfigW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 12: {
		...
		r2->out.result = svcctl_CreateServiceW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 13: {
		...
		r2->out.result = svcctl_EnumDependentServicesW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 14: {
		...
		r2->out.result = svcctl_EnumServicesStatusW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 15: {
		...
		r2->out.result = svcctl_OpenSCManagerW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 16: {
		...
		r2->out.result = svcctl_OpenServiceW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 17: {
		...
		r2->out.result = svcctl_QueryServiceConfigW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 18: {
		...
		r2->out.result = svcctl_QueryServiceLockStatusW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 19: {
		...
		r2->out.result = svcctl_StartServiceW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 20: {
		...
		r2->out.result = svcctl_GetServiceDisplayNameW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 21: {
		...
		r2->out.result = svcctl_GetServiceKeyNameW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 22: {
		...
		r2->out.result = svcctl_SCSetServiceBitsA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 23: {
		...
		r2->out.result = svcctl_ChangeServiceConfigA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 24: {
		...
		r2->out.result = svcctl_CreateServiceA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 25: {
		...
		r2->out.result = svcctl_EnumDependentServicesA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 26: {
		...
		r2->out.result = svcctl_EnumServicesStatusA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 27: {
		...
		r2->out.result = svcctl_OpenSCManagerA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 28: {
		...
		r2->out.result = svcctl_OpenServiceA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 29: {
		...
		r2->out.result = svcctl_QueryServiceConfigA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 30: {
		...
		r2->out.result = svcctl_QueryServiceLockStatusA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 31: {
		...
		r2->out.result = svcctl_StartServiceA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 32: {
		...
		r2->out.result = svcctl_GetServiceDisplayNameA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 33: {
		...
		r2->out.result = svcctl_GetServiceKeyNameA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 34: {
		...
		r2->out.result = svcctl_GetCurrentGroupeStateW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 35: {
		...
		r2->out.result = svcctl_EnumServiceGroupW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 36: {
		...
		r2->out.result = svcctl_ChangeServiceConfig2A(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 37: {
		...
		r2->out.result = svcctl_ChangeServiceConfig2W(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 38: {
		...
		r2->out.result = svcctl_QueryServiceConfig2A(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 39: {
		...
		r2->out.result = svcctl_QueryServiceConfig2W(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 40: {
		...
		r2->out.result = svcctl_QueryServiceStatusEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 41: {
		...
		r2->out.result = EnumServicesStatusExA(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 42: {
		...
		r2->out.result = EnumServicesStatusExW(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 43: {
		...
		r2->out.result = svcctl_SCSendTSMessage(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
...
static NTSTATUS svcctl__op_ndr_push(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_push *push, const void *r)
{
	...
	status = dcerpc_table_svcctl.calls[opnum].ndr_push(push, NDR_OUT, r);
	if (!NT_STATUS_IS_OK(status)) {
		dce_call->fault_code = DCERPC_FAULT_NDR;
		return NT_STATUS_NET_WRITE_FAULT;
	}
...
static const struct dcesrv_interface svcctl_interface = {
	.name		= "svcctl",
...
static NTSTATUS svcctl__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	for (i=0;i<dcerpc_table_svcctl.endpoints->count;i++) {
		NTSTATUS ret;
		const char *name = dcerpc_table_svcctl.endpoints->names[i];

		ret = dcesrv_interface_register(dce_ctx, name, &svcctl_interface, NULL);
...
{
	if (svcctl_interface.syntax_id.if_version == if_version &&
		GUID_equal(&svcctl_interface.syntax_id.uuid, uuid)) {
		memcpy(iface,&svcctl_interface, sizeof(*iface));
		return True;
	}
...
{
	if (strcmp(svcctl_interface.name, name)==0) {
		memcpy(iface,&svcctl_interface, sizeof(*iface));
		return True;
	}
