...
static const struct dcerpc_interface_call initshutdown_calls[] = {
	{
		"initshutdown_Init",
...
static const struct dcerpc_endpoint_list initshutdown_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list initshutdown_authservices = {
	.count	= 1,
