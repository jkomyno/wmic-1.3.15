...
struct dfs_Info6 {
	const char *entry_path;/* [unique,string,charset(UTF16)] */
	const char *comment;/* [unique,string,charset(UTF16)] */
	uint32_t state;
	uint32_t timeout;
	struct GUID guid;
...
struct dfs_Info200 {
	const char *dom_root;/* [unique,string,charset(UTF16)] */
};
...
struct dfs_Add {
	struct {
		const char *path;/* [ref,string,charset(UTF16)] */
		const char *server;/* [ref,string,charset(UTF16)] */
		const char *share;/* [unique,string,charset(UTF16)] */
		const char *comment;/* [unique,string,charset(UTF16)] */
		uint32_t flags;
	} in;
...
struct dfs_Remove {
	struct {
		const char *dfs_entry_path;/* [ref,string,charset(UTF16)] */
		const char *servername;/* [unique,string,charset(UTF16)] */
		const char *sharename;/* [unique,string,charset(UTF16)] */
	} in;
...
struct dfs_SetInfo {
	struct {
		const char *dfs_entry_path;/* [string,charset(UTF16)] */
		const char *servername;/* [unique,string,charset(UTF16)] */
		const char *sharename;/* [unique,string,charset(UTF16)] */
		uint32_t level;
...
struct dfs_AddFtRoot {
	struct {
		const char *servername;/* [string,charset(UTF16)] */
		const char *dns_servername;/* [string,charset(UTF16)] */
		const char *dfsname;/* [string,charset(UTF16)] */
		const char *rootshare;/* [string,charset(UTF16)] */
		const char *comment;/* [string,charset(UTF16)] */
		const char *dfs_config_dn;/* [string,charset(UTF16)] */
		uint8_t unknown1;
		uint32_t flags;
...
struct dfs_ManagerInitialize {
	struct {
		const char *servername;/* [ref,string,charset(UTF16)] */
		uint32_t flags;
	} in;
...
struct dfs_AddStdRootForced {
	struct {
		...
		const char *rootshare;/* [string,charset(UTF16)] */
		const char *comment;/* [string,charset(UTF16)] */
		const char *store;/* [string,charset(UTF16)] */
	} in;
...
struct dfs_EnumEx {
	struct {
		const char *dfs_name;/* [string,charset(UTF16)] */
		uint32_t level;
		uint32_t bufsize;
		struct dfs_EnumStruct *info;/* [unique] */
		uint32_t *total;/* [unique] */
