...
static const struct dcerpc_interface_call winreg_calls[] = {
	{
		"winreg_OpenHKCR",
...
static const struct dcerpc_endpoint_list winreg_endpoints = {
	.count	= 3,
...
static const struct dcerpc_authservice_list winreg_authservices = {
	.count	= 3,
