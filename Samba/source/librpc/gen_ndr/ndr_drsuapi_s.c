...
static NTSTATUS drsuapi__op_bind(struct dcesrv_call_state *dce_call, const struct dcesrv_interface *iface)
{
...
static NTSTATUS drsuapi__op_ndr_pull(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_pull *pull, void **r)
{
	...
	if (opnum >= dcerpc_table_drsuapi.num_calls) {
		dce_call->fault_code = DCERPC_FAULT_OP_RNG_ERROR;
		return NT_STATUS_NET_WRITE_FAULT;
	}

	*r = talloc_size(mem_ctx, dcerpc_table_drsuapi.calls[opnum].struct_size);
	NT_STATUS_HAVE_NO_MEMORY(*r);

        /* unravel the NDR for the packet */
	status = dcerpc_table_drsuapi.calls[opnum].ndr_pull(pull, NDR_IN, *r);
	if (!NT_STATUS_IS_OK(status)) {
		dcerpc_log_packet(&dcerpc_table_drsuapi, opnum, NDR_IN,
...
static NTSTATUS drsuapi__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 0: {
		...
		r2->out.result = drsuapi_DsBind(dce_call, mem_ctx, r2);
	...
	case 1: {
		...
		r2->out.result = drsuapi_DsUnbind(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 2: {
		...
		r2->out.result = drsuapi_DsReplicaSync(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 3: {
		...
		r2->out.result = drsuapi_DsGetNCChanges(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 4: {
		...
		r2->out.result = drsuapi_DsReplicaUpdateRefs(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 5: {
		struct DRSUAPI_REPLICA_ADD *r2 = (struct DRSUAPI_REPLICA_ADD *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_ADD, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_REPLICA_ADD(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_ADD will reply async\n"));
		}
		break;
	}
	case 6: {
		struct DRSUAPI_REPLICA_DEL *r2 = (struct DRSUAPI_REPLICA_DEL *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_DEL, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_REPLICA_DEL(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_DEL will reply async\n"));
		}
		break;
	}
	case 7: {
		struct DRSUAPI_REPLICA_MODIFY *r2 = (struct DRSUAPI_REPLICA_MODIFY *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_MODIFY, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_REPLICA_MODIFY(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_MODIFY will reply async\n"));
		}
		break;
	}
	case 8: {
		...
		r2->out.result = DRSUAPI_VERIFY_NAMES(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 9: {
		...
		r2->out.result = drsuapi_DsGetMemberships(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 10: {
		...
		r2->out.result = DRSUAPI_INTER_DOMAIN_MOVE(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 11: {
		struct DRSUAPI_GET_NT4_CHANGELOG *r2 = (struct DRSUAPI_GET_NT4_CHANGELOG *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_GET_NT4_CHANGELOG, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_GET_NT4_CHANGELOG(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_GET_NT4_CHANGELOG will reply async\n"));
		}
		break;
	}
	case 12: {
		...
		r2->out.result = drsuapi_DsCrackNames(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 13: {
		...
		r2->out.result = drsuapi_DsWriteAccountSpn(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 14: {
		...
		r2->out.result = drsuapi_DsRemoveDSServer(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 15: {
		...
		r2->out.result = DRSUAPI_REMOVE_DS_DOMAIN(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 16: {
		...
		r2->out.result = drsuapi_DsGetDomainControllerInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 17: {
		...
		r2->out.result = drsuapi_DsAddEntry(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 18: {
		struct DRSUAPI_EXECUTE_KCC *r2 = (struct DRSUAPI_EXECUTE_KCC *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_EXECUTE_KCC, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_EXECUTE_KCC(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_EXECUTE_KCC will reply async\n"));
		}
		break;
	}
	case 19: {
		...
		r2->out.result = drsuapi_DsReplicaGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 20: {
		...
		r2->out.result = DRSUAPI_ADD_SID_HISTORY(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 21: {
		...
		r2->out.result = drsuapi_DsGetMemberships2(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 22: {
		...
		r2->out.result = DRSUAPI_REPLICA_VERIFY_OBJECTS(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 23: {
		...
		r2->out.result = DRSUAPI_GET_OBJECT_EXISTENCE(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 24: {
		struct DRSUAPI_QUERY_SITES_BY_COST *r2 = (struct DRSUAPI_QUERY_SITES_BY_COST *)r;
		if (DEBUGLEVEL >= 10) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_QUERY_SITES_BY_COST, NDR_IN, r2);
		}
		r2->out.result = DRSUAPI_QUERY_SITES_BY_COST(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_QUERY_SITES_BY_COST will reply async\n"));
		}
		break;
	}
...
static NTSTATUS drsuapi__op_reply(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 5: {
		struct DRSUAPI_REPLICA_ADD *r2 = (struct DRSUAPI_REPLICA_ADD *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_ADD replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_ADD, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_REPLICA_ADD\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 6: {
		struct DRSUAPI_REPLICA_DEL *r2 = (struct DRSUAPI_REPLICA_DEL *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_DEL replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_DEL, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_REPLICA_DEL\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 7: {
		struct DRSUAPI_REPLICA_MODIFY *r2 = (struct DRSUAPI_REPLICA_MODIFY *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_REPLICA_MODIFY replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_REPLICA_MODIFY, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_REPLICA_MODIFY\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 8: {
	...
	case 11: {
		struct DRSUAPI_GET_NT4_CHANGELOG *r2 = (struct DRSUAPI_GET_NT4_CHANGELOG *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_GET_NT4_CHANGELOG replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_GET_NT4_CHANGELOG, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_GET_NT4_CHANGELOG\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 12: {
	...
	case 18: {
		struct DRSUAPI_EXECUTE_KCC *r2 = (struct DRSUAPI_EXECUTE_KCC *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_EXECUTE_KCC replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_EXECUTE_KCC, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_EXECUTE_KCC\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
	case 19: {
	...
	case 24: {
		struct DRSUAPI_QUERY_SITES_BY_COST *r2 = (struct DRSUAPI_QUERY_SITES_BY_COST *)r;
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
			DEBUG(5,("function DRSUAPI_QUERY_SITES_BY_COST replied async\n"));
		}
		if (DEBUGLEVEL >= 10 && dce_call->fault_code == 0) {
			NDR_PRINT_FUNCTION_DEBUG(DRSUAPI_QUERY_SITES_BY_COST, NDR_OUT | NDR_SET_VALUES, r2);
		}
		if (dce_call->fault_code != 0) {
			DEBUG(2,("dcerpc_fault %s in DRSUAPI_QUERY_SITES_BY_COST\n", dcerpc_errstr(mem_ctx, dce_call->fault_code)));
		}
		break;
	}
...
static NTSTATUS drsuapi__op_ndr_push(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_push *push, const void *r)
{
	...
	status = dcerpc_table_drsuapi.calls[opnum].ndr_push(push, NDR_OUT, r);
	if (!NT_STATUS_IS_OK(status)) {
		dce_call->fault_code = DCERPC_FAULT_NDR;
		return NT_STATUS_NET_WRITE_FAULT;
	}
...
static const struct dcesrv_interface drsuapi_interface = {
	.name		= "drsuapi",
...
static NTSTATUS drsuapi__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	for (i=0;i<dcerpc_table_drsuapi.endpoints->count;i++) {
		NTSTATUS ret;
		const char *name = dcerpc_table_drsuapi.endpoints->names[i];

		ret = dcesrv_interface_register(dce_ctx, name, &drsuapi_interface, NULL);
...
{
	if (drsuapi_interface.syntax_id.if_version == if_version &&
		GUID_equal(&drsuapi_interface.syntax_id.uuid, uuid)) {
		memcpy(iface,&drsuapi_interface, sizeof(*iface));
		return True;
	}
...
{
	if (strcmp(drsuapi_interface.name, name)==0) {
		memcpy(iface,&drsuapi_interface, sizeof(*iface));
		return True;
	}
