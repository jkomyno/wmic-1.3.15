...
struct netr_UasInfo {
	...
	const char *computer;/* [unique,string,charset(UTF16)] */
	const char *domain;/* [unique,string,charset(UTF16)] */
	const char *script_path;/* [unique,string,charset(UTF16)] */
	uint32_t unknown;
};
...
union netr_DELTA_ID_UNION {
	...
	const char *name;/* [unique,string,charset(UTF16),case(NETR_DELTA_SECRET)] */
}/* [switch_type(netr_DeltaEnum)] */;
...
struct netr_NETLOGON_INFO_2 {
	uint32_t flags;
	uint32_t pdc_connection_status;
	const char *trusted_dc_name;/* [string,charset(UTF16)] */
...
union netr_CONTROL_DATA_INFORMATION {
	const char *domain;/* [unique,string,charset(UTF16),case(NETLOGON_CONTROL_REDISCOVER)] */
	uint32_t debug_level;/* [case(NETLOGON_CONTROL_SET_DBFLAG)] */
};

struct netr_DsRGetDCNameInfo {
	const char *dc_unc;/* [unique,string,charset(UTF16)] */
	const char *dc_address;/* [unique,string,charset(UTF16)] */
	int32_t dc_address_type;
	struct GUID domain_guid;
	const char *domain_name;/* [unique,string,charset(UTF16)] */
	const char *forest_name;/* [unique,string,charset(UTF16)] */
	uint32_t dc_flags;
	const char *dc_site_name;/* [unique,string,charset(UTF16)] */
	const char *client_site_name;/* [unique,string,charset(UTF16)] */
};
...
struct netr_DomainQuery1 {
	...
	const char *workstation_domain;/* [unique,string,charset(UTF16)] */
	const char *workstation_site;/* [unique,string,charset(UTF16)] */
	const char *unknown1;/* [unique,string,charset(UTF16)] */
	const char *unknown2;/* [unique,string,charset(UTF16)] */
	const char *unknown3;/* [unique,string,charset(UTF16)] */
	const char *unknown4;/* [unique,string,charset(UTF16)] */
...
struct netr_LogonUasLogon {
	struct {
		...
		const char *account_name;/* [string,charset(UTF16)] */
		const char *workstation;/* [string,charset(UTF16)] */
	} in;
...
struct netr_LogonSamLogon {
	struct {
		const char *server_name;/* [unique,string,charset(UTF16)] */
		const char *computer_name;/* [unique,string,charset(UTF16)] */
...
struct netr_ServerReqChallenge {
	struct {
		const char *server_name;/* [unique,string,charset(UTF16)] */
		const char *computer_name;/* [string,charset(UTF16)] */
...
struct netr_DatabaseDeltas {
	struct {
		const char *logon_server;/* [string,charset(UTF16)] */
		const char *computername;/* [string,charset(UTF16)] */
		struct netr_Authenticator credential;
		struct netr_Authenticator return_authenticator;
...
struct netr_AccountDeltas {
	...
	struct {
		struct netr_Authenticator return_authenticator;
		struct netr_AccountBuffer buffer;/* [subcontext(4)] */
...
struct netr_GetDcName {
	struct {
		const char *logon_server;/* [string,charset(UTF16)] */
		const char *domainname;/* [unique,string,charset(UTF16)] */
	} in;

	struct {
		const char *dcname;/* [unique,string,charset(UTF16)] */
		NTSTATUS result;
	} out;
...
struct netr_LogonControl {
	...
	struct {
		union netr_CONTROL_QUERY_INFORMATION info;/* [switch_is(level)] */
		WERROR result;
	} out;
...
struct netr_LogonControl2 {
	...
	struct {
		union netr_CONTROL_QUERY_INFORMATION query;/* [switch_is(level)] */
		WERROR result;
	} out;
...
struct netr_DsRGetDCName {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *domain_name;/* [unique,string,charset(UTF16)] */
...
struct netr_DsRGetSiteName {
	...
	struct {
		const char *site;/* [unique,string,charset(UTF16)] */
		WERROR result;
	} out;
...
struct netr_LogonGetDomainInfo {
	struct {
		const char *server_name;/* [string,charset(UTF16)] */
		const char *computer_name;/* [unique,string,charset(UTF16)] */
	...
	struct {
		struct netr_Authenticator *return_authenticator;/* [ref] */
		union netr_DomainInfo info;/* [switch_is(level)] */
		NTSTATUS result;
	} out;
...
struct netr_DsRGetDCNameEx2 {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *client_account;/* [unique,string,charset(UTF16)] */
		uint32_t mask;
		const char *domain_name;/* [unique,string,charset(UTF16)] */
		struct GUID *domain_guid;/* [unique] */
		const char *site_name;/* [unique,string,charset(UTF16)] */
...
struct netr_DsrEnumerateDomainTrusts {
	...
	struct {
		uint32_t count;
		struct netr_DomainTrust *trusts;/* [unique,size_is(count)] */
		WERROR result;
	} out;
