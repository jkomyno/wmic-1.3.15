...
struct SERVICE_LOCK_STATUS {
	uint32_t is_locked;
	const char *lock_owner;/* [unique,string,charset(UTF16)] */
...
struct svcctl_ChangeServiceConfigW {
	struct {
		...
		const char *binary_path;/* [unique,string,charset(UTF16)] */
		const char *load_order_group;/* [unique,string,charset(UTF16)] */
		uint32_t *tag_id;/* [unique] */
		uint8_t *dependencies;/* [unique,size_is(dependencies_size)] */
		uint32_t dependencies_size;
		const char *service_start_name;/* [unique,string,charset(UTF16)] */
		uint8_t *password;/* [unique,size_is(password_size)] */
		uint32_t password_size;
		const char *display_name;/* [unique,string,charset(UTF16)] */
	} in;
...
struct svcctl_CreateServiceW {
	struct {
		...
		uint32_t start_type;
		uint32_t error_control;
		const char *binary_path;/* [string,charset(UTF16)] */
		const char *load_order_group;/* [unique,string,charset(UTF16)] */
		uint32_t *tag_id;/* [unique] */
		uint8_t *dependencies;/* [unique,size_is(dependencies_size)] */
		uint32_t dependencies_size;
...
struct svcctl_OpenSCManagerW {
	struct {
		const char *MachineName;/* [unique,string,charset(UTF16)] */
		const char *DatabaseName;/* [unique,string,charset(UTF16)] */
...
struct svcctl_OpenServiceW {
	struct {
		struct policy_handle *scmanager_handle;/* [ref] */
		const char *ServiceName;/* [string,charset(UTF16)] */
		uint32_t access_mask;
	} in;
...
struct svcctl_StartServiceW {
	struct {
		struct policy_handle *handle;/* [ref] */
		uint32_t NumArgs;
		const char *Arguments;/* [unique,string,charset(UTF16),length_is(NumArgs)] */
	} in;
...
struct svcctl_GetServiceDisplayNameW {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *service_name;/* [unique,string,charset(UTF16)] */
...
struct svcctl_GetServiceKeyNameW {
	...
	struct {
		const char *key_name;/* [unique,string,charset(UTF16)] */
		uint32_t *display_name_length;/* [unique] */
		WERROR result;
	} out;
...
struct svcctl_ChangeServiceConfigA {
	struct {
		...
		const char *binary_path;/* [unique,string,charset(UTF16)] */
		const char *load_order_group;/* [unique,string,charset(UTF16)] */
		const char *dependencies;/* [unique,string,charset(UTF16)] */
		const char *service_start_name;/* [unique,string,charset(UTF16)] */
...
struct svcctl_CreateServiceA {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *ServiceName;/* [unique,string,charset(UTF16)] */
		const char *DisplayName;/* [unique,string,charset(UTF16)] */
		uint32_t desired_access;
		uint32_t type;
		uint32_t start_type;
		uint32_t error_control;
		const char *binary_path;/* [unique,string,charset(UTF16)] */
		const char *LoadOrderGroupKey;/* [unique,string,charset(UTF16)] */
		const char *dependencies;/* [unique,string,charset(UTF16)] */
		const char *service_start_name;/* [unique,string,charset(UTF16)] */
		const char *password;/* [unique,string,charset(UTF16)] */
	} in;
...
struct EnumServicesStatusExA {
	...
	struct {
		...
		uint32_t *resume_handle;/* [unique] */
		const char *group_name;/* [unique,string,charset(UTF16)] */
		WERROR result;
	} out;
