...
static NTSTATUS ndr_push_scerpc_Unknown0(struct ndr_push *ndr, int flags, const struct scerpc_Unknown0 *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_scerpc_Unknown0(struct ndr_pull *ndr, int flags, struct scerpc_Unknown0 *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call scerpc_calls[] = {
	{
		"scerpc_Unknown0",
...
static const struct dcerpc_endpoint_list scerpc_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list scerpc_authservices = {
	.count	= 1,
	.names	= scerpc_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_scerpc = {
	.name		= "scerpc",
	.syntax_id	= {
		{0x93149ca2,0x973b,0x11d1,{0x8c,0x39},{0x00,0xc0,0x4f,0xb9,0x84,0xf9}},
		DCERPC_SCERPC_VERSION
	},
	.helpstring	= DCERPC_SCERPC_HELPSTRING,
	.num_calls	= 1,
	.calls		= scerpc_calls,
