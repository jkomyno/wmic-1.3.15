...
struct srvsvc_NetCharDevInfo0 {
	const char *device;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetCharDevQInfo1 {
	const char *device;/* [unique,string,charset(UTF16)] */
	uint32_t priority;
	const char *devices;/* [unique,string,charset(UTF16)] */
	uint32_t users;
	uint32_t num_ahead;
};
...
struct srvsvc_NetConnInfo1 {
	...
	uint32_t conn_time;
	const char *user;/* [unique,string,charset(UTF16)] */
	const char *share;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetFileInfo3 {
	...
	uint32_t num_locks;
	const char *path;/* [unique,string,charset(UTF16)] */
	const char *user;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetSessInfo2 {
	...
	uint32_t idle_time;
	uint32_t user_flags;
	const char *client_type;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetSessInfo502 {
	...
	uint32_t user_flags;
	const char *client_type;/* [unique,string,charset(UTF16)] */
	const char *transport;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetShareInfo1 {
	...
	const char *comment;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetShareInfo2 {
	...
	const char *path;/* [unique,string,charset(UTF16)] */
	const char *password;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetShareInfo1007 {
	uint32_t flags;
	const char *alternate_directory_name;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetSrvInfo102 {
	...
	uint32_t anndelta;
	uint32_t licenses;
	const char *userpath;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetSrvInfo402 {
	...
	const char *alerts;/* [unique,string,charset(UTF16)] */
	uint32_t security;
	uint32_t numadmin;
	uint32_t lanmask;
	const char *guestaccount;/* [unique,string,charset(UTF16)] */
	uint32_t chdevs;
	uint32_t chdevqs;
	uint32_t chdevjobs;
	...
	uint32_t netioalert;
	uint32_t maxaudits;
	const char *srvheuristics;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetSrvInfo403 {
	...
	const char *autopath;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetTransportInfo0 {
	...
	uint32_t addr_len;
	const char *net_addr;/* [unique,string,charset(UTF16)] */
};
...
struct srvsvc_NetCharDevGetInfo {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *device_name;/* [string,charset(UTF16)] */
		uint32_t level;
	} in;

	struct {
		union srvsvc_NetCharDevInfo info;/* [switch_is(level)] */
		WERROR result;
	} out;
...
struct srvsvc_NetCharDevQGetInfo {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *queue_name;/* [string,charset(UTF16)] */
		const char *user;/* [string,charset(UTF16)] */
		uint32_t level;
	} in;
...
struct srvsvc_NetFileGetInfo {
	...
	struct {
		union srvsvc_NetFileInfo info;/* [switch_is(level)] */
		WERROR result;
	} out;
...
struct srvsvc_NetShareGetInfo {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *share_name;/* [string,charset(UTF16)] */
		uint32_t level;
	} in;
...
struct srvsvc_NetServerStatisticsGet {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *service;/* [unique,string,charset(UTF16)] */
		uint32_t level;
		uint32_t options;
	} in;

	struct {
		struct srvsvc_Statistics stat;
		WERROR result;
	} out;
...
struct srvsvc_NetTransportEnum {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		uint32_t level;
		union srvsvc_NetTransportCtr transports;/* [switch_is(level)] */
		uint32_t max_buffer;
		uint32_t *resume_handle;/* [unique] */
	} in;
...
struct srvsvc_NetPathType {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *path;/* [string,charset(UTF16)] */
		uint32_t pathflags;
	} in;
...
struct srvsvc_NetPathCanonicalize {
	struct {
		...
		const char *path;/* [string,charset(UTF16)] */
		uint32_t maxbuf;
		const char *prefix;/* [string,charset(UTF16)] */
		uint32_t pathtype;
		uint32_t pathflags;
	} in;
...
struct srvsvc_NetPathCompare {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *path1;/* [string,charset(UTF16)] */
		const char *path2;/* [string,charset(UTF16)] */
		uint32_t pathtype;
		uint32_t pathflags;
	} in;
...
struct srvsvc_NetNameValidate {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *name;/* [string,charset(UTF16)] */
		uint32_t name_type;
		uint32_t flags;
	} in;
...
struct srvsvc_NetPRNameCompare {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *name1;/* [string,charset(UTF16)] */
		const char *name2;/* [string,charset(UTF16)] */
		uint32_t name_type;
		uint32_t flags;
	} in;
...
struct srvsvc_NetShareDelStart {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *share;/* [string,charset(UTF16)] */
		uint32_t reserved;
	} in;
...
struct srvsvc_NetGetFileSecurity {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *share;/* [unique,string,charset(UTF16)] */
		const char *file;/* [string,charset(UTF16)] */
...
struct srvsvc_NetServerSetServiceBitsEx {
	struct {
		const char *server_unc;/* [unique,string,charset(UTF16)] */
		const char *emulated_server_unc;/* [unique,string,charset(UTF16)] */
		const char *transport;/* [unique,string,charset(UTF16)] */
