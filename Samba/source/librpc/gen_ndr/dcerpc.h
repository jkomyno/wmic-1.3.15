...
#define DCERPC_MAX_SIGN_SIZE	( 32 )
...
#define DCERPC_PFC_FLAG_ORPC	( 0x80 )
...
struct dcerpc_ctx_list {
	...
	struct dcerpc_syntax_id abstract_syntax;
	struct dcerpc_syntax_id *transfer_syntaxes;
};
...
struct dcerpc_bind_ack {
	...
	uint16_t max_recv_frag;
	uint32_t assoc_group_id;
	const char * secondary_address;/* [flag(LIBNDR_FLAG_STR_ASCII|LIBNDR_FLAG_STR_SIZE2)] */
