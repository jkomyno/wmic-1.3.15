...
#define DCERPC_NTSVCS_UUID "8d9f4e40-a03d-11ce-8f69-08003e30051b"
#define DCERPC_NTSVCS_VERSION 1.0
#define DCERPC_NTSVCS_NAME "ntsvcs"
#define DCERPC_NTSVCS_HELPSTRING "Plug and Play services"
extern const struct dcerpc_interface_table dcerpc_table_ntsvcs;
NTSTATUS dcerpc_server_ntsvcs_init(void);
#define DCERPC_PNP_DISCONNECT (0x00)

#define DCERPC_PNP_CONNECT (0x01)

#define DCERPC_PNP_GETVERSION (0x02)

#define DCERPC_PNP_GETGLOBALSTATE (0x03)

#define DCERPC_PNP_INITDETECTION (0x04)

#define DCERPC_PNP_REPORTLOGON (0x05)

#define DCERPC_PNP_VALIDATEDEVICEINSTANCE (0x06)

#define DCERPC_PNP_GETROOTDEVICEINSTANCE (0x07)

#define DCERPC_PNP_GETRELATEDDEVICEINSTANCE (0x08)

#define DCERPC_PNP_ENUMERATESUBKEYS (0x09)

#define DCERPC_PNP_GETDEVICELIST (0x0a)

#define DCERPC_PNP_GETDEVICELISTSIZE (0x0b)

#define DCERPC_PNP_GETDEPTH (0x0c)

#define DCERPC_PNP_GETDEVICEREGPROP (0x0d)

#define DCERPC_PNP_SETDEVICEREGPROP (0x0e)

#define DCERPC_PNP_GETCLASSINSTANCE (0x0f)

#define DCERPC_PNP_CREATEKEY (0x10)

#define DCERPC_PNP_DELETEREGISTRYKEY (0x11)

#define DCERPC_PNP_GETCLASSCOUNT (0x12)

#define DCERPC_PNP_GETCLASSNAME (0x13)

#define DCERPC_PNP_DELETECLASSKEY (0x14)

#define DCERPC_PNP_GETINTERFACEDEVICEALIAS (0x15)

#define DCERPC_PNP_GETINTERFACEDEVICELIST (0x16)

#define DCERPC_PNP_GETINTERFACEDEVICELISTSIZE (0x17)

#define DCERPC_PNP_REGISTERDEVICECLASSASSOCIATION (0x18)

#define DCERPC_PNP_UNREGISTERDEVICECLASSASSOCIATION (0x19)

#define DCERPC_PNP_GETCLASSREGPROP (0x1a)

#define DCERPC_PNP_SETCLASSREGPROP (0x1b)

#define DCERPC_PNP_CREATEDEVINST (0x1c)

#define DCERPC_PNP_DEVICEINSTANCEACTION (0x1d)

#define DCERPC_PNP_GETDEVICESTATUS (0x1e)

#define DCERPC_PNP_SETDEVICEPROBLEM (0x1f)

#define DCERPC_PNP_DISABLEDEVINST (0x20)

#define DCERPC_PNP_UNINSTALLDEVINST (0x21)

#define DCERPC_PNP_ADDID (0x22)

#define DCERPC_PNP_REGISTERDRIVER (0x23)

#define DCERPC_PNP_QUERYREMOVE (0x24)

#define DCERPC_PNP_REQUESTDEVICEEJECT (0x25)

#define DCERPC_PNP_ISDOCKSTATIONPRESENT (0x26)

#define DCERPC_PNP_REQUESTEJECTPC (0x27)

#define DCERPC_PNP_HWPROFFLAGS (0x28)

#define DCERPC_PNP_GETHWPROFINFO (0x29)

#define DCERPC_PNP_ADDEMPTYLOGCONF (0x2a)

#define DCERPC_PNP_FREELOGCONF (0x2b)

#define DCERPC_PNP_GETFIRSTLOGCONF (0x2c)

#define DCERPC_PNP_GETNEXTLOGCONF (0x2d)

#define DCERPC_PNP_GETLOGCONFPRIORITY (0x2e)

#define DCERPC_PNP_ADDRESDES (0x2f)

#define DCERPC_PNP_FREERESDES (0x30)

#define DCERPC_PNP_GETNEXTRESDES (0x31)

#define DCERPC_PNP_GETRESDESDATA (0x32)

#define DCERPC_PNP_GETRESDESDATASIZE (0x33)

#define DCERPC_PNP_MODIFYRESDES (0x34)

#define DCERPC_PNP_DETECTRESOURCELIMIT (0x35)

#define DCERPC_PNP_QUERYRESCONFLIST (0x36)

#define DCERPC_PNP_SETHWPROF (0x37)

#define DCERPC_PNP_QUERYARBITRATORFREEDATA (0x38)

#define DCERPC_PNP_QUERYARBITRATORFREESIZE (0x39)

#define DCERPC_PNP_RUNDETECTION (0x3a)

#define DCERPC_PNP_REGISTERNOTIFICATION (0x3b)

#define DCERPC_PNP_UNREGISTERNOTIFICATION (0x3c)

#define DCERPC_PNP_GETCUSTOMDEVPROP (0x3d)

#define DCERPC_PNP_GETVERSIONINTERNAL (0x3e)

#define DCERPC_PNP_GETBLOCKEDDRIVERINFO (0x3f)

#define DCERPC_PNP_GETSERVERSIDEDEVICEINSTALLFLAGS (0x40)

#define DCERPC_NTSVCS_CALL_COUNT (65)
