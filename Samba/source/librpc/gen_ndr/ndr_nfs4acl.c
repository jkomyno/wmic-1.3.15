...
static NTSTATUS ndr_push_nfs4ace(struct ndr_push *ndr, int ndr_flags, const struct nfs4ace *r)
{
	{
...
static NTSTATUS ndr_pull_nfs4ace(struct ndr_pull *ndr, int ndr_flags, struct nfs4ace *r)
{
	{
		uint32_t _flags_save_STRUCT = ndr->flags;
		ndr_set_flags(&ndr->flags, LIBNDR_FLAG_BIGENDIAN);
...
_PUBLIC_ NTSTATUS ndr_push_nfs4acl(struct ndr_push *ndr, int ndr_flags, const struct nfs4acl *r)
{
	uint32_t cntr_ace_0;
	{
		uint32_t _flags_save_STRUCT = ndr->flags;
...
_PUBLIC_ NTSTATUS ndr_pull_nfs4acl(struct ndr_pull *ndr, int ndr_flags, struct nfs4acl *r)
{
	uint32_t cntr_ace_0;
	TALLOC_CTX *_mem_save_ace_0;
	{
		uint32_t _flags_save_STRUCT = ndr->flags;
		ndr_set_flags(&ndr->flags, LIBNDR_FLAG_BIGENDIAN);
		if (ndr_flags & NDR_SCALARS) {
			...
			NDR_PULL_ALLOC_N(ndr, r->ace, r->a_count);
...
_PUBLIC_ void ndr_print_nfs4acl(struct ndr_print *ndr, const char *name, const struct nfs4acl *r)
{
	...
	ndr_print_struct(ndr, name, "nfs4acl");
	{
		...
		ndr->print(ndr, "%s: ARRAY(%d)", "ace", r->a_count);
		ndr->depth++;
		for (cntr_ace_0=0;cntr_ace_0<r->a_count;cntr_ace_0++) {
			char *idx_0=NULL;
			asprintf(&idx_0, "[%d]", cntr_ace_0);
			if (idx_0) {
...
static NTSTATUS ndr_push_nfs4acl_test(struct ndr_push *ndr, int flags, const struct nfs4acl_test *r)
{
	if (flags & NDR_IN) {
...
static NTSTATUS ndr_pull_nfs4acl_test(struct ndr_pull *ndr, int flags, struct nfs4acl_test *r)
{
	if (flags & NDR_IN) {
...
static const struct dcerpc_interface_call nfs4acl_calls[] = {
	{
		"nfs4acl_test",
...
static const char * const nfs4acl_endpoint_strings[] = {
	"ncacn_np:[\\pipe\\nfs4acl]", 
};

static const struct dcerpc_endpoint_list nfs4acl_endpoints = {
	.count	= 1,
	.names	= nfs4acl_endpoint_strings
};

static const char * const nfs4acl_authservice_strings[] = {
	"host", 
};

static const struct dcerpc_authservice_list nfs4acl_authservices = {
	.count	= 1,
	.names	= nfs4acl_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_nfs4acl = {
	.name		= "nfs4acl",
	.syntax_id	= {
		{0x18763978,0x8625,0xabc3,{0x54,0xca},{0x98,0x92,0xba,0xcd,0xf3,0x21}},
		DCERPC_NFS4ACL_VERSION
	},
	.helpstring	= DCERPC_NFS4ACL_HELPSTRING,
	.num_calls	= 1,
	.calls		= nfs4acl_calls,
	.endpoints	= &nfs4acl_endpoints,
	.authservices	= &nfs4acl_authservices
};
