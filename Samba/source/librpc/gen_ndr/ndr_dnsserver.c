...
static NTSTATUS ndr_push_dnsserver_foo(struct ndr_push *ndr, int flags, const struct dnsserver_foo *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_dnsserver_foo(struct ndr_pull *ndr, int flags, struct dnsserver_foo *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call dnsserver_calls[] = {
	{
		"dnsserver_foo",
...
static const struct dcerpc_endpoint_list dnsserver_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list dnsserver_authservices = {
	.count	= 1,
	.names	= dnsserver_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_dnsserver = {
	.name		= "dnsserver",
	.syntax_id	= {
		{0x50abc2a4,0x574d,0x40b3,{0x9d,0x66},{0xee,0x4f,0xd5,0xfb,0xa0,0x76}},
		DCERPC_DNSSERVER_VERSION
	},
	.helpstring	= DCERPC_DNSSERVER_HELPSTRING,
	.num_calls	= 1,
