...
static NTSTATUS ndr_push_policyagent_Dummy(struct ndr_push *ndr, int flags, const struct policyagent_Dummy *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_policyagent_Dummy(struct ndr_pull *ndr, int flags, struct policyagent_Dummy *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call policyagent_calls[] = {
	{
		"policyagent_Dummy",
...
static const struct dcerpc_endpoint_list policyagent_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list policyagent_authservices = {
	.count	= 1,
	.names	= policyagent_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_policyagent = {
	.name		= "policyagent",
	.syntax_id	= {
		{0xd335b8f6,0xcb31,0x11d0,{0xb0,0xf9},{0x00,0x60,0x97,0xba,0x4e,0x54}},
		DCERPC_POLICYAGENT_VERSION
	},
	.helpstring	= DCERPC_POLICYAGENT_HELPSTRING,
	.num_calls	= 1,
