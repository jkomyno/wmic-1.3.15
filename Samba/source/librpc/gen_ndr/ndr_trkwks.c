...
static NTSTATUS ndr_push_trkwks_Unknown0(struct ndr_push *ndr, int flags, const struct trkwks_Unknown0 *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static NTSTATUS ndr_pull_trkwks_Unknown0(struct ndr_pull *ndr, int flags, struct trkwks_Unknown0 *r)
{
	if (flags & NDR_IN) {
	}
	if (flags & NDR_OUT) {
...
static const struct dcerpc_interface_call trkwks_calls[] = {
	{
		"trkwks_Unknown0",
...
static const struct dcerpc_endpoint_list trkwks_endpoints = {
	.count	= 1,
...
static const struct dcerpc_authservice_list trkwks_authservices = {
	.count	= 1,
	.names	= trkwks_authservice_strings
};


const struct dcerpc_interface_table dcerpc_table_trkwks = {
	.name		= "trkwks",
	.syntax_id	= {
		{0x300f3532,0x38cc,0x11d0,{0xa3,0xf0},{0x00,0x20,0xaf,0x6b,0x0a,0xdd}},
		DCERPC_TRKWKS_VERSION
	},
	.helpstring	= DCERPC_TRKWKS_HELPSTRING,
	.num_calls	= 1,
	.calls		= trkwks_calls,
