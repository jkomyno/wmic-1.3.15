...
static NTSTATUS srvsvc__op_bind(struct dcesrv_call_state *dce_call, const struct dcesrv_interface *iface)
{
...
static NTSTATUS srvsvc__op_ndr_pull(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_pull *pull, void **r)
{
	...
	if (opnum >= dcerpc_table_srvsvc.num_calls) {
		dce_call->fault_code = DCERPC_FAULT_OP_RNG_ERROR;
		return NT_STATUS_NET_WRITE_FAULT;
	}

	*r = talloc_size(mem_ctx, dcerpc_table_srvsvc.calls[opnum].struct_size);
	NT_STATUS_HAVE_NO_MEMORY(*r);

        /* unravel the NDR for the packet */
	status = dcerpc_table_srvsvc.calls[opnum].ndr_pull(pull, NDR_IN, *r);
	if (!NT_STATUS_IS_OK(status)) {
		dcerpc_log_packet(&dcerpc_table_srvsvc, opnum, NDR_IN,
...
static NTSTATUS srvsvc__op_dispatch(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, void *r)
{
	...
	case 0: {
		...
		r2->out.result = srvsvc_NetCharDevEnum(dce_call, mem_ctx, r2);
	...
	case 1: {
		...
		r2->out.result = srvsvc_NetCharDevGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 2: {
		...
		r2->out.result = srvsvc_NetCharDevControl(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 3: {
		...
		r2->out.result = srvsvc_NetCharDevQEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 4: {
		...
		r2->out.result = srvsvc_NetCharDevQGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 5: {
		...
		r2->out.result = srvsvc_NetCharDevQSetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 6: {
		...
		r2->out.result = srvsvc_NetCharDevQPurge(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 7: {
		...
		r2->out.result = srvsvc_NetCharDevQPurgeSelf(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 8: {
		...
		r2->out.result = srvsvc_NetConnEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 9: {
		...
		r2->out.result = srvsvc_NetFileEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 10: {
		...
		r2->out.result = srvsvc_NetFileGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 11: {
		...
		r2->out.result = srvsvc_NetFileClose(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 12: {
		...
		r2->out.result = srvsvc_NetSessEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 13: {
		...
		r2->out.result = srvsvc_NetSessDel(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 14: {
		...
		r2->out.result = srvsvc_NetShareAdd(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 15: {
		...
		r2->out.result = srvsvc_NetShareEnumAll(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 16: {
		...
		r2->out.result = srvsvc_NetShareGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 17: {
		...
		r2->out.result = srvsvc_NetShareSetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 18: {
		...
		r2->out.result = srvsvc_NetShareDel(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 19: {
		...
		r2->out.result = srvsvc_NetShareDelSticky(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 20: {
		...
		r2->out.result = srvsvc_NetShareCheck(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 21: {
		...
		r2->out.result = srvsvc_NetSrvGetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 22: {
		...
		r2->out.result = srvsvc_NetSrvSetInfo(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 23: {
		...
		r2->out.result = srvsvc_NetDiskEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 24: {
		...
		r2->out.result = srvsvc_NetServerStatisticsGet(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 25: {
		...
		r2->out.result = srvsvc_NetTransportAdd(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 26: {
		...
		r2->out.result = srvsvc_NetTransportEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 27: {
		...
		r2->out.result = srvsvc_NetTransportDel(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 28: {
		...
		r2->out.result = srvsvc_NetRemoteTOD(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 29: {
		...
		r2->out.result = srvsvc_NetSetServiceBits(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 30: {
		...
		r2->out.result = srvsvc_NetPathType(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 31: {
		...
		r2->out.result = srvsvc_NetPathCanonicalize(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 32: {
		...
		r2->out.result = srvsvc_NetPathCompare(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 33: {
		...
		r2->out.result = srvsvc_NetNameValidate(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 34: {
		...
		r2->out.result = srvsvc_NETRPRNAMECANONICALIZE(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 35: {
		...
		r2->out.result = srvsvc_NetPRNameCompare(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 36: {
		...
		r2->out.result = srvsvc_NetShareEnum(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 37: {
		...
		r2->out.result = srvsvc_NetShareDelStart(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 38: {
		...
		r2->out.result = srvsvc_NetShareDelCommit(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 39: {
		...
		r2->out.result = srvsvc_NetGetFileSecurity(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 40: {
		...
		r2->out.result = srvsvc_NetSetFileSecurity(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 41: {
		...
		r2->out.result = srvsvc_NetServerTransportAddEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 42: {
		...
		r2->out.result = srvsvc_NetServerSetServiceBitsEx(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 43: {
		...
		r2->out.result = srvsvc_NETRDFSGETVERSION(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 44: {
		...
		r2->out.result = srvsvc_NETRDFSCREATELOCALPARTITION(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 45: {
		...
		r2->out.result = srvsvc_NETRDFSDELETELOCALPARTITION(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 46: {
		...
		r2->out.result = srvsvc_NETRDFSSETLOCALVOLUMESTATE(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 47: {
		...
		r2->out.result = srvsvc_NETRDFSSETSERVERINFO(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 48: {
		...
		r2->out.result = srvsvc_NETRDFSCREATEEXITPOINT(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 49: {
		...
		r2->out.result = srvsvc_NETRDFSDELETEEXITPOINT(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 50: {
		...
		r2->out.result = srvsvc_NETRDFSMODIFYPREFIX(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 51: {
		...
		r2->out.result = srvsvc_NETRDFSFIXLOCALVOLUME(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 52: {
		...
		r2->out.result = srvsvc_NETRDFSMANAGERREPORTSITEINFO(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
	...
	case 53: {
		...
		r2->out.result = srvsvc_NETRSERVERTRANSPORTDELEX(dce_call, mem_ctx, r2);
		if (dce_call->state_flags & DCESRV_CALL_STATE_FLAG_ASYNC) {
...
static NTSTATUS srvsvc__op_ndr_push(struct dcesrv_call_state *dce_call, TALLOC_CTX *mem_ctx, struct ndr_push *push, const void *r)
{
	...
	status = dcerpc_table_srvsvc.calls[opnum].ndr_push(push, NDR_OUT, r);
	if (!NT_STATUS_IS_OK(status)) {
		dce_call->fault_code = DCERPC_FAULT_NDR;
		return NT_STATUS_NET_WRITE_FAULT;
	}
...
static const struct dcesrv_interface srvsvc_interface = {
	.name		= "srvsvc",
...
static NTSTATUS srvsvc__op_init_server(struct dcesrv_context *dce_ctx, const struct dcesrv_endpoint_server *ep_server)
{
	...
	for (i=0;i<dcerpc_table_srvsvc.endpoints->count;i++) {
		NTSTATUS ret;
		const char *name = dcerpc_table_srvsvc.endpoints->names[i];

		ret = dcesrv_interface_register(dce_ctx, name, &srvsvc_interface, NULL);
...
{
	if (srvsvc_interface.syntax_id.if_version == if_version &&
		GUID_equal(&srvsvc_interface.syntax_id.uuid, uuid)) {
		memcpy(iface,&srvsvc_interface, sizeof(*iface));
		return True;
	}
...
{
	if (strcmp(srvsvc_interface.name, name)==0) {
		memcpy(iface,&srvsvc_interface, sizeof(*iface));
		return True;
	}
