...
#define DCERPC_DSSETUP_UUID "3919286a-b10c-11d0-9ba8-00c04fd92ef5"
#define DCERPC_DSSETUP_VERSION 0.0
#define DCERPC_DSSETUP_NAME "dssetup"
#define DCERPC_DSSETUP_HELPSTRING "Active Directory Setup"
extern const struct dcerpc_interface_table dcerpc_table_dssetup;
NTSTATUS dcerpc_server_dssetup_init(void);
#define DCERPC_DSSETUP_DSROLEGETPRIMARYDOMAININFORMATION (0x00)

#define DCERPC_DSSETUP_DSROLEDNSNAMETOFLATNAME (0x01)

#define DCERPC_DSSETUP_DSROLEDCASDC (0x02)

#define DCERPC_DSSETUP_DSROLEDCASREPLICA (0x03)

#define DCERPC_DSSETUP_DSROLEDEMOTEDC (0x04)

#define DCERPC_DSSETUP_DSROLEGETDCOPERATIONPROGRESS (0x05)

#define DCERPC_DSSETUP_DSROLEGETDCOPERATIONRESULTS (0x06)

#define DCERPC_DSSETUP_DSROLECANCEL (0x07)

#define DCERPC_DSSETUP_DSROLESERVERSAVESTATEFORUPGRADE (0x08)

#define DCERPC_DSSETUP_DSROLEUPGRADEDOWNLEVELSERVER (0x09)

#define DCERPC_DSSETUP_DSROLEABORTDOWNLEVELSERVERUPGRADE (0x0a)

#define DCERPC_DSSETUP_CALL_COUNT (11)
