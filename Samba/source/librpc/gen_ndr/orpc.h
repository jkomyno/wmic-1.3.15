...
struct ORPC_EXTENT {
	struct GUID id;
	uint32_t size;
	uint8_t *data;/* [noprint,size_is(((size+7)&~7))] */
}/* [public] */;
...
struct STRINGBINDING {
	uint16_t wTowerId;
	const char * NetworkAddr;/* [flag(LIBNDR_FLAG_STR_NULLTERM)] */
...
struct SECURITYBINDING {
	uint16_t wAuthnSvc;
	uint16_t wAuthzSvc;
	const char * PrincName;/* [flag(LIBNDR_FLAG_STR_NULLTERM)] */
}/* [public,flag(LIBNDR_FLAG_NOALIGN)] */;
...
}/* [public,flag(LIBNDR_FLAG_LITTLE_ENDIAN)] */;
