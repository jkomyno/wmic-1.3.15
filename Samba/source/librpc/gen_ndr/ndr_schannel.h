...
#define DCERPC_SCHANNEL_CALL_COUNT (0)
...
NTSTATUS ndr_push_schannel_bind(struct ndr_push *ndr, int ndr_flags, const struct schannel_bind *r);
NTSTATUS ndr_pull_schannel_bind(struct ndr_pull *ndr, int ndr_flags, struct schannel_bind *r);
void ndr_print_schannel_bind(struct ndr_print *ndr, const char *name, const struct schannel_bind *r);
NTSTATUS ndr_push_schannel_bind_ack(struct ndr_push *ndr, int ndr_flags, const struct schannel_bind_ack *r);
NTSTATUS ndr_pull_schannel_bind_ack(struct ndr_pull *ndr, int ndr_flags, struct schannel_bind_ack *r);
