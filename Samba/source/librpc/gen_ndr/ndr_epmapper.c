...
static NTSTATUS ndr_push_epm_Map(struct ndr_push *ndr, int flags, const struct epm_Map *r)
{
...
static NTSTATUS ndr_pull_epm_Map(struct ndr_pull *ndr, int flags, struct epm_Map *r)
{
	uint32_t _ptr_object;
...
static const struct dcerpc_interface_call epmapper_calls[] = {
	{
		"epm_Insert",
...
static const struct dcerpc_endpoint_list epmapper_endpoints = {
	.count	= 3,
...
static const struct dcerpc_authservice_list epmapper_authservices = {
	.count	= 3,
